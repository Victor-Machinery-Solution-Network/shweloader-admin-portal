...
export const BULK_UPLOAD_CONFIGS: Record<string, BulkUploadConfig> = {
  ...
  listings: {
    ...
    columns: [
      ...
      {
        header: "Sale MMK Price",
        field: "sale_mmk_price",
        type: "number",
        required: false,
        excelWidth: 18,
        helpText: "MMK price for sale listing. Leave blank if not for sale.",
      },
      {
        header: "Sale USD Price",
        field: "sale_usd_price",
        type: "number",
        required: false,
        excelWidth: 18,
        helpText: "USD price for sale listing. Leave blank if not for sale.",
      },
      {
        header: "Rental MMK Price",
        field: "rent_mmk_price",
        type: "number",
        required: false,
        excelWidth: 18,
        helpText: "MMK price for rental listing. Leave blank if not for rent.",
      },
      {
        header: "Rental USD Price",
        field: "rent_usd_price",
        type: "number",
        required: false,
        excelWidth: 18,
        helpText: "USD price for rental listing. Leave blank if not for rent.",
      },
      {
        header: "Sale Display Currency",
        field: "sale_display_currency",
        type: "select",
        required: false,
        options: [
          { label: "MMK", value: "MMK" },
        ...
        excelWidth: 20,
        helpText: "Currency shown on app for sale listing. Defaults to MMK.",
      },
      {
        header: "Rent Display Currency",
        field: "rent_display_currency",
        type: "select",
        required: false,
        options: [
          { label: "MMK", value: "MMK" },
        ...
        excelWidth: 20,
        helpText: "Currency shown on app for rental listing. Defaults to MMK.",
      },
      {
        header: "State/Region",
        field: "state_region",
        ...
        excelWidth: 20,
        helpText: "State or region name. Used to filter districts.",
      },
      {
        header: "District",
        field: "district",
        ...
        lookupKey: "districts",
        excelWidth: 20,
        helpText: "District name. Used to filter townships.",
        dependsOn: {
          parentField: "state_region",
          associationKey: "districtsByStateRegion",
        },
      },
      {
        header: "Township",
        ...
        lookupKey: "townships",
        excelWidth: 20,
        helpText: "Township name for listing location.",
        dependsOn: {
          parentField: "district",
          associationKey: "townshipsByDistrict",
        },
      },
      {
        header: "Description",
      ...
      {
        header: "Hide Seller Info",
        field: "hide_partner",
        type: "boolean",
        required: false,
        excelWidth: 15,
        helpText: "Yes or No. Hides seller/partner info from public view.",
      },
      {
        header: "Hide Display",
        field: "is_hidden",
      ...
      },
      {
        ...
        maxLength: 100,
        excelWidth: 18,
        helpText: "Custom field label (e.g., Year, Hours Used).",
      },
      {
    ...
    instructions:
      "Enter one listing per row. Each listing must have a product type, model, partner, and listing type. Sale/Rental prices are separate — fill in the relevant columns based on the listing type.",
  },
  ...
  "state-regions": {
    ...
    columns: [
      ...
      },
      {
        ...
        maxLength: 100,
        excelWidth: 30,
        helpText: "Burmese (Unicode) name. Required.",
      },
      {
        header: "Type",
        field: "type",
