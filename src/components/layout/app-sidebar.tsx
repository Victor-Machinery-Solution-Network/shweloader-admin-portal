...
export function AppSidebar() {
  ...
  const showArticles = canRead("articles") || canRead("article_categories");
  ...
  const showMarketplace =
    showListings || canRead("enquiries") || canRead("chat");
  ...
  const bulkPrefix = `${ROUTES.BULK_UPLOAD}/`;
  const bulkEntity = pathname.startsWith(bulkPrefix)
    ? pathname.slice(bulkPrefix.length)
    : null;
  const isBulkEntity = (...entities: string[]) =>
    !!bulkEntity && entities.includes(bulkEntity);
  ...
  const isListingsActive =
    ...
    pathname.startsWith(ROUTES.CONDITION_TYPES) ||
    isBulkEntity("listings", "condition-types");
  const isArticlesActive =
    pathname.startsWith("/articles") || isBulkEntity("article-categories");
  const isPostsActive = pathname.startsWith(ROUTES.POSTS);
  ...
  return (
    <>
                          ...
                          {canRead("equipment_main_categories") && (
                            <SidebarMenuSubItem>
                              <SidebarMenuSubButton
                                ...
                                isActive={
                                  pathname ===
                                    ROUTES.EQUIPMENT_MAIN_CATEGORIES ||
                                  isBulkEntity("equipment-main-categories")
                                }
                              >
                          ...
                          {canRead("equipment_sub_categories") && (
                            <SidebarMenuSubItem>
                              <SidebarMenuSubButton
                                ...
                                isActive={
                                  pathname ===
                                    ROUTES.EQUIPMENT_SUB_CATEGORIES ||
                                  isBulkEntity("equipment-sub-categories")
                                }
                              >
                          ...
                          {canRead("equipment_models") && (
                            <SidebarMenuSubItem>
                              <SidebarMenuSubButton
                                asChild
                                isActive={
                                  pathname === ROUTES.EQUIPMENT_MODELS ||
                                  isBulkEntity("equipment-models")
                                }
                              >
                          ...
                          {canRead("attachment_categories") && (
                            <SidebarMenuSubItem>
                              <SidebarMenuSubButton
                                asChild
                                isActive={
                                  pathname === ROUTES.ATTACHMENT_CATEGORIES ||
                                  isBulkEntity("attachment-categories")
                                }
                              >
                          ...
                          {canRead("attachment_models") && (
                            <SidebarMenuSubItem>
                              <SidebarMenuSubButton
                                asChild
                                isActive={
                                  pathname === ROUTES.ATTACHMENT_MODELS ||
                                  isBulkEntity("attachment-models")
                                }
                              >
                  ...
                  {canRead("brands") && (
                    <SidebarMenuItem>
                      <SidebarMenuButton
                        asChild
                        isActive={
                          pathname === ROUTES.BRANDS || isBulkEntity("brands")
                        }
                      >
                          ...
                          {(canCreate("sale_listings") ||
                            ...
                            <SidebarMenuSubItem>
                              <SidebarMenuSubButton
                                ...
                                isActive={
                                  pathname === ROUTES.LISTINGS_NEW ||
                                  isBulkEntity("listings")
                                }
                          ...
                          {canRead("condition_types") && (
                            <SidebarMenuSubItem>
                              <SidebarMenuSubButton
                                asChild
                                isActive={
                                  pathname === ROUTES.CONDITION_TYPES ||
                                  isBulkEntity("condition-types")
                                }
                              >
                                <Link href={ROUTES.CONDITION_TYPES}>
                          ...
                          {canRead("article_categories") && (
                            <SidebarMenuSubItem>
                              <SidebarMenuSubButton
                                asChild
                                isActive={
                                  pathname === ROUTES.ARTICLE_CATEGORIES ||
                                  isBulkEntity("article-categories")
                                }
                              >
                  ...
                  {canRead("carousels") && (
                    <SidebarMenuItem>
                      <SidebarMenuButton
                        asChild
                        isActive={
                          pathname === ROUTES.CAROUSEL_IMAGES ||
                          isBulkEntity("carousel-images")
                        }
                      >
                  ...
                  {canRead("announcements") && (
                    <SidebarMenuItem>
                      <SidebarMenuButton
                        asChild
                        isActive={
                          pathname === ROUTES.ANNOUNCEMENT_BAR ||
                          isBulkEntity("announcements")
                        }
                      >
      ...
      {/* Add Listing Dialog */}
      <Dialog
        open={showAddListingDialog}
        onOpenChange={setShowAddListingDialog}
      >
