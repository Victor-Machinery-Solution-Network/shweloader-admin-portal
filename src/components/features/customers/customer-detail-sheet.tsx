...
export function CustomerDetailSheet({
  ...
  // Keep last customer data visible during close animation
  const prevRef = useRef<Customer | null>(null);
  if (customer) prevRef.current = customer;
  const data = customer ?? prevRef.current;
