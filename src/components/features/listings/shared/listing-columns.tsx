...
function saleFilterColumns(): ColumnDef<SaleListingWithDetails>[] {
  return [
    ...
    // Category taxonomy — filter-only. Equipment subcategory is populated on
    // equipment rows, the attachment category on attachment rows; null on the
    // other type (the filter UI drops null/empty options automatically).
